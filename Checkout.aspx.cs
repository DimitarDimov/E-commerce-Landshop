...
public partial class Checkout : System.Web.UI.Page
{
  ...
  private void PopulateControls()
  {
    ...
    if (!addressOK)
    {
      ...
      {
        InfoLabel.Text =
          "Трябва да предоставите валиден адрес и дебитна карта "
          + "преди да завършите поръчката.";
      }
      else
      {
        InfoLabel.Text =
         "Трябда да предоставите валиден адрес преди да завършите "
         + "поръчката.";
      }
    }
    else if (!cardOK)
    {
      InfoLabel.Text = "Трябва да предоставите дебитна карта преди "
        + "да завършите поръчката.";
    }
    else
    {
      InfoLabel.Text = 
        "Моля потвърдете, че всички детайли са "
        + "правилни преди завършване.";
    }
