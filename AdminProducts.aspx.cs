...
public partial class AdminProducts : System.Web.UI.Page
{
  ...
  GridViewCancelEditEventArgs e)
  {
    ...
    grid.EditIndex = -1;
    // Set status message
    statusLabel.Text = "Промяна отказана";
    // Reload the grid
    BindGrid();
  }
  ...
  protected void grid_RowUpdating(object sender, GridViewUpdateEventArgs e)
  {
    ...
    try
    {
      ...
      statusLabel.Text = success ? "Обновяване на продукт успешно" : "Обновяване на продукт неуспешно";
    }
    catch
    {
      // Display error
      statusLabel.Text = "Обновяване на продукт неуспешно";
    }
    // Reload grid
    BindGrid();
  }
